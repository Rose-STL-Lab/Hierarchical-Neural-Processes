...
class Model(nn.Module):
    ...
    def forward(self, l2_x_all=None, l2_y_all=None, l2_adj_all=None, batches_seen=None, test=False, l2_z_mu_all=None, l2_z_cov_all=None, l2_z_mu_c=None, l2_z_cov_c=None):
        """
