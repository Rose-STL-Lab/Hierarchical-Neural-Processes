...
class Model(nn.Module):
    ...
    def forward(self, l1_x_all=None, l1_y_all=None, l2_x_all=None, l2_y_all=None, batches_seen=None, test=False, l1_z_mu_all=None, l1_z_cov_all=None, l1_z_mu_c=None, l1_z_cov_c=None, l2_z_mu_all=None, l2_z_cov_all=None, l2_z_mu_c=None, l2_z_cov_c=None):
        ...
        if test==False:
            ...
            l2_r_all_test = torch.repeat_interleave(torch.unsqueeze(l2_r_all,dim=1),50,dim=1)
            l2_r_all = torch.repeat_interleave(torch.unsqueeze(l2_r_all,dim=1),l2_x_t.size(0),dim=1)


            l2_r_c = self.xy_to_r(l2_x_c, l2_y_c, level=2)
            l2_r_c = torch.repeat_interleave(torch.unsqueeze(l2_r_c,dim=1),l2_x_t.size(0),dim=1)
            ...
            l2_z_mu_all_test, l2_z_cov_all_test = self.mean_z_agg(l2_r_all_test,level=2,z_mu=l2_z_mu_all_0_test)
