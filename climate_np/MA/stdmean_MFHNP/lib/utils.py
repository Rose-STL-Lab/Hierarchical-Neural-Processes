...
class DataLoader(object):
    def __init__(self, xs, ys, batch_size, pad_with_last_sample=True, shuffle=False, p_larger_size=None):
        """
        ...
        if p_larger_size is not None:
            if current_size < p_larger_size:
                xs = np.pad(xs, ((0,p_larger_size-current_size),(0, 0),(0, 0),(0, 0)), 'wrap')
                ys = np.pad(ys, ((0,p_larger_size-current_size),(0, 0),(0, 0),(0, 0)), 'wrap')
...
def load_dataset(dataset_dir, batch_size, test_batch_size=None, **kwargs):
    ...
    data['l1_train_loader'] = DataLoader(data['x_train_l1'], data['y_train_l1'], batch_size, shuffle=True, p_larger_size=len(data['x_train_l2']))
    data['l2_train_loader'] = DataLoader(data['x_train_l2'], data['y_train_l2'], batch_size, shuffle=True, p_larger_size=len(data['x_train_l1']))
