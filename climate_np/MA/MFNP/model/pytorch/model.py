...
class Model(nn.Module):
    def __init__(self, logger, **model_kwargs):
        ...
        self.l2_z_encoder_model = L2_MLP_ZEncoder(self.z_dim, self.z_dim, self.z_hidden_layers, self.z_hidden_dim)
    ...
    def xy_to_r(self, y_low, x, y, level):
        ...
        if level == 2:
            ...
            r_mu = self.l2_encoder_model(torch.cat([y1_low, r1],dim=-3))
    ...
    def forward(self, l1_y_all=None, l2_x_all=None, l2_y_all=None, batches_seen=None, test=False, l2_z_mu_all=None, l2_z_cov_all=None, l2_z_mu_c=None, l2_z_cov_c=None):
        ...
        if test==False:
            ...
            #l2_encoder
            l2_r_all = self.xy_to_r(l1_y_all, l2_x_all, l2_y_all, level=2)
            l2_r_c = self.xy_to_r(l1_y_c, l2_x_c, l2_y_c, level=2)
